...
from py2cpp import *
from py2cpp.concur.thread import Barrier, BoundedSemaphore, BrokenBarrierError, CancelledError, Condition, Empty, Event, Full, Future, Lock, Queue, RLock, Semaphore, ShutDown, Thread, ThreadPool, TimeoutError, atomic
...
class BarrierTests(TestCaseMixin):
    ...
    def test(self):
        ...
        action_waiter: Thread = new(lambda: barrier_waiter(action_barrier, action_ready, action_done, Box()))
        action_waiter.start()
