...
# Source: third_party/posix/sys/wait.h
...
@native
@native_name("wait")
def pyiWait(status: Pointer[int]) -> int:
  ...

@native
@native_name("waitpid")
def pyiWaitpid(pid: int, status: Pointer[int], options: int) -> int:
  ...

# stats: structs=0 enums=0 aliases=0 consts=0 funcs=2
