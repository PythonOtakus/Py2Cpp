...
from py2cpp.math.stat import LinearRegression, NormalDist, correlation, covariance, fmean, geometric_mean, harmonic_mean, linear_regression, mean, median, median_grouped, median_high, median_low, mode, multimode, pstdev, pvariance, quantiles, stdev, variance
_REL: float64 = 1e-09
_ABS: float64 = 1e-06
...
class StatNormalDistTests(TestCaseMixin):
    ...
    def test(self):
        ...
        self.assertTrue(isclose(n.inv_cdf(0.5), 0.0, _REL, 1e-06))
