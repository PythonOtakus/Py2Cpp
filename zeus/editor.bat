...
echo === [zeus] translate editor_main ===
%PY% main.py zeus\src\editor_main.py -o zeus\generated
if errorlevel 1 exit /b 1

echo === [zeus] compile editor_main ===
cl /nologo /EHsc /utf-8 /std:c++14 ^
  ...
  "%ZEUS_ROOT%generated\zeus\src\editor_main.cpp" ^
  "%SQLITE_INC%\sqlite3.c" ^
  /Fe:"%ZEUS_ROOT%generated\zeus\src\editor_main.exe" ^
...
echo === [zeus] launch editor ===
start "" /D "%REPO_ROOT%" "%ZEUS_ROOT%generated\zeus\src\editor_main.exe"
exit /b 0
