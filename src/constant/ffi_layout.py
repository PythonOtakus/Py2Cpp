...
_FFI_GLUE_ALLOWLIST: dict[str, frozenset[str] | None] = {
  ...
  "ffi/crt/string": frozenset({"strlen", "wcslen"}),
...
_FFI_HEADER_SYMBOL_ALLOWLIST: dict[str, frozenset[str]] = {
  ...
  "ffi/crt/string": frozenset({"pyiStrlen", "pyiWcslen"}),
...
_FFI_HEADER_EXTRA_STRUCT_USINGS: dict[str, dict[str, str]] = {
  "ffi/windows": {
    ...
    "PyiProcessInformation": "_PROCESS_INFORMATION",
    "PyiStartupinfoW": "_STARTUPINFOW",
    "PyiOverlapped": "_OVERLAPPED",
  },
  "ffi/crt/stat": {
