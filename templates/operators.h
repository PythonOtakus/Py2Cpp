...
PY2CPP_TYPE(PyStr) format(PyInt v, PyUtf8Ptr format_spec = "");
PY2CPP_TYPE(PyStr) format(PyFloat v, PyUtf8Ptr format_spec = "");
PY2CPP_TYPE(PyStr) format(PyBool v, PyUtf8Ptr format_spec = "");
PY2CPP_TYPE(PyStr) format(PyChar v, PyUtf8Ptr format_spec = "");
PY2CPP_TYPE(PyStr) format(const PY2CPP_TYPE(PyStr)& v, PyUtf8Ptr format_spec = "");
/// 枚举（``enum class``）按底层整型 ``format``。
template<typename E>
typename std::enable_if<std::is_enum<E>::value, PY2CPP_TYPE(PyStr)>::type
format(E v, PyUtf8Ptr format_spec = "")
{
...
template<typename T>
auto format(const T& obj, PyUtf8Ptr format_spec) -> decltype(obj.__format__(PY2CPP_TYPE(PyStr)(format_spec ? format_spec : "")))
{
...
PY2CPP_TYPE(PyStr) format(PyInt64 v, PyUtf8Ptr format_spec = "");
PY2CPP_TYPE(PyStr) format(PyFloat64 v, PyUtf8Ptr format_spec = "");
