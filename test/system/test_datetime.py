...
from py2cpp.system.time import asctime, gmtime, gmtime_now, localtime, mktime, strftime, strptime, c_time, time as wall_time
...
class MktimeTests(TestCaseMixin):
    ...
    @override
    def test(self):
        sec: float64 = mktime(c_time(2020, 1, 1, 0, 0, 0))
